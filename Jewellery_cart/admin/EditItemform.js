...
const EditItemform = ({ values,dirty, errors, touched, isSubmitting,props }) => (
    <div>
         <br></br><br></br><br></br>
        <h1>Add Issue</h1>
        <br></br><br></br>
        <Form>
            <div>Item Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
            <Field type="text" name="title" value={props.title} placeholder="title"/>
            {touched.title && errors.title && <span style={{ color: 'red' }}>{errors.title}</span>}
            </div><br></br>
            <div>Item Desription&nbsp;:&nbsp;
                <Field type="text" name="isd" value={props.description} placeholder="Isd"/>
                {touched.isd && errors.isd && <span style={{ color: 'red' }}>{errors.isd}</span>}<br/><br/>
            </div>
            <div>
                    category&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
                <Field as="select" value={props.category} name="category">
            ...
            <div>
            Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
            <Field type="number" value={props.price} name="price" placeholder="price"/>
            {touched.price && errors.price && <span style={{ color: 'red' }}>{errors.price}</span>}
            </div><br></br>
            <div>
            Image Link&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
            <Field type="text" value={props.image} name="image" placeholder="image"/>
